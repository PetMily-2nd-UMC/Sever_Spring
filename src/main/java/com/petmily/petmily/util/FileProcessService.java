...
public class FileProcessService {
    ...
    public String uploadFile(MultipartFile file, ServiceCategory category){
    ...
    private String createFileName(String fileName){
        return "petmily_"+ UUID.randomUUID().toString().concat(getFileExtension(fileName));
    }
    ...
    public void deleteFile(String url, ServiceCategory category){
        logger.error(url);
